...
class TokenFlow:
    """Main orchestrator for TokenFlow."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = TokenFlowCore(threshold=self.threshold, verbose=verbose)
...
def main():
    parser = argparse.ArgumentParser(description="TokenFlow")
...
# revision 9 (2025-09-19): review pass

# revision 20 (2026-02-23): review pass

# revision 21 (2026-03-02): review pass

# revision 27 (2026-04-21): review pass
